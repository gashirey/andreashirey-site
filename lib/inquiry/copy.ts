export const inquiryCopy = {
  pageTitle: "Inquire",
  metaDescription:
    "Begin a commission inquiry with Andrea Shirey Photography — select commissions, limited availability.",
  intro:
    "Andrea accepts a limited number of commissions each season so each client experience can be personal, intentional, and fully considered. Please share a little about what you're hoping to create.",
  ...
  confirmation: {
    ...
    paragraphs: [
      ...
      "For select commissions, the consultation fee may be credited toward the final session investment.",
    ],
...
export const inquiryCtas = {
  primary: { label: "Inquire About a Commission", href: "/inquire" },
